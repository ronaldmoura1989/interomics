---
title: "InterOmics - Integration Scripts"
...
Basically, you need to have previously processed both WES and RNAseq data. We present an object called *multiomics_individual_data* with an ideal input for the R commands that follows. In order to execute de commands, the package *tidyverse* v.2.0.0 would be essential to get all the integration we amid to make.
